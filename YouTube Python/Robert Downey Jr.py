...
def files():
    positions()
    draw(positions.dress, 0)
    draw(positions.face, 0)
    draw(positions.internal_face, 0, (255, 255, 255))
    draw(positions.mouth, 0)
    draw(positions.nose, 0)
    draw(positions.eyebrow, 0)
    draw(positions.lines, 1, thickness = 2)
    draw(positions.eyes, 0)
    draw(positions.eyeballs, 0, (255, 255, 255))
